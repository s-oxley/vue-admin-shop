  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col w-56 border-r border-gray-300">
      ...
      <div class="flex flex-col flex-grow p-4 overflow-auto">
        ...
        >
          <span class="leading-none">Admin</span>
        </RouterLink>
        <RouterLink
        ...
        <a
          class="flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium bg-blue-500 hover:bg-blue-700 text-white rounded"
          href="#"
        >
          <svg
            class="w-5 h-5"
...
//const { username, logout } = storeToRefs(useAuthStore());
